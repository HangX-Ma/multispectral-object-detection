...
# dataset_dir_vi = '/hy-tmp/visdrone/visible/train'
dataset_dir_vi = '/hy-tmp/visdrone/visible/test'
output_dir_vi = '/hy-tmp/visdrone/visible/images'

# dataset_dir_ir = '/hy-tmp/visdrone/infrared/train'
dataset_dir_ir = '/hy-tmp/visdrone/infrared/test'
output_dir_ir = '/hy-tmp/visdrone/infrared/images'

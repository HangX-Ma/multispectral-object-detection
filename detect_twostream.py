...
if __name__ == '__main__':
    ...
    parser.add_argument('--source1', type=str, default='/hy-tmp/align/visible/images', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/hy-tmp/align/infrared/images', help='source')  # file/folder, 0 for webcam

...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='/root/multispectral-object-detection/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='/hy-tmp/LLVIP/infrared/images', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/hy-tmp/LLVIP/visible/images', help='source')  # file/folder, 0 for webcam
